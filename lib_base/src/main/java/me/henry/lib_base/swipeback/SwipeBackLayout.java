package me.henry.lib_base.swipeback;
...
import me.henry.lib_base.swipeback.app.SwipeBackListenerActivityAdapter;
...
public class SwipeBackLayout extends FrameLayout {
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.base_SwipeBackLayoutStyle);
    }
    ...
    public SwipeBackLayout(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.base_SwipeBackLayout, defStyle,
                R.style.base_SwipeBackLayout);
