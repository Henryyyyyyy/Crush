...
public class CPreferencesUtil {
    ...
    /** 调试模式_Toast */
    public final static String DEBUG_MODE_TOAST = "DEBUG_MODE_TOAST";
    /** 是否格式化log */
    public static final String CONFIG_IS_FORMAT_LOG = "CONFIG_IS_FORMAT_LOG";
