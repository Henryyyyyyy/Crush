package me.henry.lib_base.ninebitmap;
...
import me.henry.lib_base.others.util.ScreenUtil;
...
public class NinePatchChunk implements Externalizable {
	 ...
	 * 检查气泡框尺寸，兼容低分辨率手机
	 */
	public static void checkBubbleSize(Context context, NinePatchDrawable drawable){
		//兼容低分辨率手机
		if (ScreenUtil.getCreenDpi(context)<=320){
